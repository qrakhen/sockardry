...
const EventWatcher = function(subject, socket) {
    ...
    this.__emit = (rqid, body) => {
        this.__socket.emit(rqid, body);
    };
    this.__on = (r) => {
    ...
    this.emit = (rqid, data) => {
        this.__emit(rqid, { success: true, data: data });
    };
    this.fail = (rqid, message) => {
        this.__emit(rqid, { success: false, message: message });
    };
    this.listen = (fn) => {
        this.__listen = fn;
    };
